...
from nyanicons.avatar_component_category import AvatarComponentCategory
...
class AvatarGenerator:
    ...
    @staticmethod
    def _load_components(components_dir: str) -> List[AvatarComponentCategory]:
        ...
        component_categories = [AvatarComponentCategory(d) for d in component_category_dirs]

        return component_categories

    def generate_avatar(self, address: str) -> Avatar:
        ...
        return Avatar(nano_address, color_scheme, components)
    ...
    def _generate_component(self,
                            component_category: AvatarComponentCategory,
                            chunk: str,
